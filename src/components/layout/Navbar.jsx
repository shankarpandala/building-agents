  ...
  return (
    ...
    >
      <div className="flex h-full items-center justify-between px-4 gap-3">
        {/* Left: hamburger + pandala.in link + separator + BuildAgents logo */}
        ...
        {/* Center: subject quick-nav pills (desktop only) */}
        <nav
        ...
        {/* Right: search, theme toggle, portfolio, LinkedIn, GitHub */}
        <div className="flex items-center gap-1 shrink-0">
          ...
          {/* Portfolio link — full label on sm+, icon-only on xs */}
          <a
